...
$a ='F882CbB10';
$b ='0x4D9F4c3';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'4a7eDe8c2997282Da744326F'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x4D9F4c34a7eDe8c2997282Da744326FF882CbB10&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
